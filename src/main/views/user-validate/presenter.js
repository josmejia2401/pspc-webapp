        ...
        <main className="flex-shrink-0 form-signin m-auto">
            <div className="container">
                <form className="g-3 needs-validation" onSubmit={props.handleSignIn} noValidate>
                    ...
                    <h1 className="h3 mb-3 fw-normal text-center">Validate otp</h1>
                    <div className="row mb-3">
                        <div className="col-12">
                            <label htmlFor="floatingOtp" className="form-label">OTP</label>
                            <input type="number" className="form-control" id="floatingOtp" name="otp" placeholder="123456" required />
                            <div className="invalid-feedback">
                                OTP is required
                            </div>
                        </div>
                    </div>
                    <Button title="Activate" type="submit" className="w-100" isLoadingMain={props.state.isLoadingMain}></Button>
